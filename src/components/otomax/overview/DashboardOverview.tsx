...
import OverviewBigNumber from "./OverviewBigNumber";
import OverviewJenisTransaksi from "./OverviewJenisTransaksi";
import OverviewNilaiTransaksi from "./OverviewNilaiTransaksi";
...
export default function DashboardOverview() {   
    ...
    const changeStatusReload = () => {
        ...
        createEventLog(cookies.get('name')!, '/otomax/overview', 'metadata|status-reload', 'change', statusReload.toString())
    };
    ...
    const changeDateRange = async (newValue) => { 
        ...
        if (newValue){
            ...
            createEventLog(cookies.get('name')!, '/otomax/overview', 'metadata|datepicker', 'change', newValue)
        }
    };
    ...
    return(
        ...
        <div className="space-y-3">
            ...
            <OverviewBigNumber statusReload={statusReload} dateRange={dateRange}></OverviewBigNumber>
    
            <OverviewJenisTransaksi statusReload={statusReload} dateRange={dateRange}></OverviewJenisTransaksi>
    
            <OverviewNilaiTransaksi statusReload={statusReload} dateRange={dateRange}></OverviewNilaiTransaksi>
        </div>
