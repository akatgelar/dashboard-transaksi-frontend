...
import ModulBigNumber from "./ModulBigNumber";
import ModulOmset from "./ModulOmset";
import ModulMargin from "./ModulMargin";
...
export default function DashboardModul() {   
    ...
    const changeStatusReload = () => {
        ...
        createEventLog(cookies.get('name')!, '/otomax/modul', 'metadata|status-reload', 'change',  statusReload.toString())
    };
    ...
    const changeDateRange = async (newValue) => { 
        ...
        if (newValue){
            ...
            createEventLog(cookies.get('name')!, '/otomax/modul', 'metadata|datepicker', 'change', newValue)
        }
    };
    ...
    return(
        <div className="space-y-3"> 
            ...
            <ModulBigNumber statusReload={statusReload} dateRange={dateRange}></ModulBigNumber>

            <div className="mb-7"></div>

            <ModulTransaksi statusReload={statusReload} dateRange={dateRange}></ModulTransaksi>

            <div className="mb-7"></div>

            <ModulOmset statusReload={statusReload} dateRange={dateRange}></ModulOmset>
        
            <div className="mb-7"></div>
        
            <ModulMargin statusReload={statusReload} dateRange={dateRange}></ModulMargin>
